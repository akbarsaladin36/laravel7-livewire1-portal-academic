    ...
    public function update()
    {
        $user = DB::table('users')
                ...
                ->update([
                    ...
                    'user_updated_user_id' => Session::get('user_logged_in')->user_id,
                    'user_updated_username' => Session::get('user_logged_in')->user_username
                ]);

        Session::flash('success','Data profile anda sudah berhasil diupdate!');

        return redirect()->route('profile.index',['username'=>$this->user_username]);
    }
