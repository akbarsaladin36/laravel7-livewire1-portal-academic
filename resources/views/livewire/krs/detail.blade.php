        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $kelas_kuliah_code }}</td>
                </tr>
                <tr>
                    <td><b>Sifat Mata Kuliah</b></td>
                    <td>{{ $sifat_mata_kuliah }}</td>
                </tr>
            </tbody>
        </table>
        <a href="{{ route('krs.edit',['krs_id'=>$krs_id]) }}" class="btn btn-success form-control">Edit Detail</a>
    </div>
</div>
