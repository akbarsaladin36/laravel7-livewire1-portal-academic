...
<div class="mt-5 ms-3">
    ...
    <div class="mt-3">
        <div class="mt-3 d-flex justify-content-end">
            <a href="{{ route('pa-jurusan.detail',['jurusan_slug'=>$jurusan_slug]) }}" class="btn btn-secondary">Kembali</a>
        </div>
    </div>

    <form wire:submit.prevent="update" class="mt-3">
        <input type="hidden" name="jurusan_id" wire:model="jurusan_id" id="jurusan_id">
