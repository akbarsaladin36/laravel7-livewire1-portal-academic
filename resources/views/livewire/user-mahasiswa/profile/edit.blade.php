@section('title','Edit Profile Mahasiswa')

<div class="mt-5 ms-3">
    <div>
        <h2>Edit Profile Mahasiswa</h2>
    </div>

    <div class="mt-3">
        <div class="mt-3 d-flex justify-content-end">
            <a href="{{ route('user-mahasiswa.profile.index',['username'=>$user_username]) }}" class="btn btn-secondary">Kembali</a>
        </div>
    </div>
    ...
    <form wire:submit.prevent="update" class="mt-3">
        ...
        <div class="form-group mt-3">
            <label for="user_fakultas_id">Fakultas</label>
            <select class="form-select" name="user_fakultas_id" wire:model="user_fakultas_id">
        ...
        <div class="form-group mt-3">
            <label for="user_jurusan_id">Jurusan</label>
            <select class="form-select" name="user_jurusan_id" wire:model="user_jurusan_id">
