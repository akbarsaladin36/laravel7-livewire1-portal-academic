...
<div class="mt-5 ms-3">
    ...
    <form wire:submit.prevent="store" class="mt-3">
        ...
        <div class="form-group mt-3">
            ...
            <input type="password" name="user_password" wire:model="user_password" id="user_password" class="form-control">
        </div>
        <div class="form-group mt-3">
        ...
        <div class="form-group mt-3">
            ...
            <select class="form-select" name="user_religion" wire:model="user_religion">
                <option value="tidak-ada-agama" selected>Pilih Agama</option>
